...
// POST /api/pembelian/lampiran - upload file lampiran faktur pembelian (FormData: files[]).
// File hanya disimpan; metadata dikembalikan untuk disertakan saat menyimpan faktur.
